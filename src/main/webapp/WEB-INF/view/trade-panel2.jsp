                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="nav flex-column nav-pills nav-fill" id="v-pills-tab" role="tablist" aria-orientation="vertical" >
                            ...
                            <a class="nav-link" id="v-pills-dashboard-tab" href="${pageContext.request.contextPath}/dashboard/" role="button" aria-controls="v-pills-dashboard" aria-selected="false"><i class="fas fa-exchange-alt"></i> Dashboard</a>
                            <a class="nav-link" id="v-pills-copy-tab" href="${pageContext.request.contextPath}/copy/" role="button" aria-controls="v-pills-copy" aria-selected="true"><i class="fas fa-exchange-alt"></i> Copy</a>
                            ...
                            <security:authorize access="hasAnyRole('ADMIN', 'TRADER')">
                                <a class="nav-link active" id="v-pills-trades-tab" href="${pageContext.request.contextPath}/trade/" role="button" aria-controls="v-pills-trades" aria-selected="false"><i class="fas fa-exchange-alt"></i> Trade</a>
                            </security:authorize>
                            <security:authorize access="hasRole('ADMIN')">
                                <a class="nav-link" id="v-pills-admin-tab" href="${pageContext.request.contextPath}/admin/" role="button" aria-controls="v-pills-admin" aria-selected="false"><i class="fas fa-exchange-alt"></i> Admin Panel</a>
                            </security:authorize>
                        </div>
                    </div>
                </div>
