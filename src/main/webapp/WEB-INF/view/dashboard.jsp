            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="nav flex-column nav-pills nav-fill" id="v-pills-tab" role="tablist" aria-orientation="vertical" >
                        <a class="nav-link" id="v-pills-news-tab" href="${pageContext.request.contextPath}/user/news" role="tab"><i class="fa fa-newspaper-o" style="content: 'f1ea';"><span class="icon">&#xf1ea;</span></i> News</a>
                        ...
                        <a class="nav-link" id="v-pills-settings-tab" href="${pageContext.request.contextPath}/user/settings" role="tab"><i class="fas fa-cogs"></i> Settings</a>
