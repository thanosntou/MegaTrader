            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6 col-sm-12 col-lg-6 col-md-offset-3">
                            <form:form action="${pageContext.request.contextPath}/register/customerRegistrationForm" modelAttribute="customer" class="form-horizontal">
					...
					<form:input path="firstName" placeholder="first name" class="form-control" />
                                    ...
                                    <input type="hidden" value="customer" name="option"/>
                                </form:form>
