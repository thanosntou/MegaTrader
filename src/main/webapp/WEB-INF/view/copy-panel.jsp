            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="nav flex-column nav-pills nav-fill" id="v-pills-tab" role="tablist" aria-orientation="vertical" >
                        ...
                        <a class="nav-link active" id="v-pills-copy-tab" href="${pageContext.request.contextPath}/copy/" role="button" aria-controls="v-pills-copy" aria-selected="true"><i class="fas fa-exchange-alt"></i> Copy</a>
